...
with st.sidebar:
    ...
    # Nah, star_date dan end_date di atas akan 
    # digunakna untuk memfilter all_df. Data yang telah 
    # difilter selanjutnya akan disimpan dalam main_df
...
# tahap berikutnya kita akan menambahkan informasi terkait daily orders
# yaitu jumlah order harian serta total order dan revenu dalam range waktu tertentu
# pada proyek ini kita akan menampilkan informasi total order dan revenu dalam benteuk metric() yang ditampilkan menggunakan layout columns()
